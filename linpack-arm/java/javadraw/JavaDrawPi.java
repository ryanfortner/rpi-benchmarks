// Compile command -  javac JavaDrawPi.java
// Run command     -  java  JavaDrawPi

// Change ver below for different javac
// And here rename class and file name e.g. JavaDrawPi to JavaDrawPi
...
public class JavaDrawPi extends JPanel implements ActionListener 
{  
//   String ver = "            Produced by javac 1.6.0_27";
   String ver = "            Produced by javac 1.7.0_02";
   int x, y;  
   Timer timer;         
   ...
   private JavaDrawPi() 
   {
       ...
       try
       {
          ...
          // Create file 
          boolean append = true;
          prout = new PrintWriter(new FileWriter(new File("JavaDraw.txt"), append));
          prout.printf(" **************************************************%n");
          ...
          if (test == 6)
          {
              ...
              prout.printf("%n  Operating System    " 
               ...
               prout.printf("  " + System.getenv("PROCESSOR_IDENTIFIER")
                          ...
                          + " CPUs%n%n");
               prout.close();
               System.out.format("%n          Results in file JavaDraw.txt%n%n");
               System.exit(0);
          }
      }    
      repaint();  
   ...
   public void paintComponent(Graphics g) 
   {
      ...
      super.paintComponent(g);  
          ...
          if (test == 1 && frames == 10)
          {
               tenTime = ((double)System.currentTimeMillis() - startTime) / 1000;
               fps = 10.0 / tenTime;
               if (fps > 100)
               {
                  inc = inc * (float)(100.0 / fps);
   ...
   {  
      JFrame f = new JFrame(" JavaDrawPi");  
      f.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);  
      JavaDrawPi m = new JavaDrawPi();  
      f.add(m);  
