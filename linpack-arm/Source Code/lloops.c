/************************************************************************
 * Compile Linux Intel
 * cc  lloops.c cpuidc.c -lm -lrt -O3 -o liverloopsIL
 *
 * Cross Compile on Linux Intel for ARM
 * ~/toolchain/raspbian-toolchain-gcc-4.7.2-linux32/bin/arm-linux-gnueabihf-gcc  lloops.c cpuidc.c -lm -lrt -O3 -march=armv6 -mfloat-abi=hard -mfpu=vfp -o liverloopsPiA6
 *
 * Compile on Raspberry Pi
 * gcc  lloops.c cpuidc.c -lm -lrt -O3 -march=armv6 -mfloat-abi=hard -mfpu=vfp -o liverloopsPiA6
 *  #define options   "Opt 3 32 Bit"
 *  
 * Use lloops2.c for liverloopsPiA7
 * 
 *************************************************************************
 *
